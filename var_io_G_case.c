                ...
                int        *blocklens[6]) /* request's block lengths */
{
    ...
    if (nelems_D1 > 0) {
        ...
        for (i = 0; i < nelems_D1; i++) D1_fix_int_buf[i] = rank;
    }
    else
        D1_fix_int_buf = NULL;
    ...
    if (nelems_D2 > 0) {
        ...
        for (i = 0; i < 2 * nelems_D2; i++) D2_fix_int_buf[i] = rank;
    }
    else
        D2_fix_int_buf = NULL;
    ...
    if (nelems_D3 > 0) {
        ...
        for (i = 0; i < nelems_D3; i++) D3_fix_int_buf[i] = rank;
    }
    else
        D3_fix_int_buf = NULL;
    ...
    if (nelems_D4 > 0) {
        ...
        for (i = 0; i < nelems_D4; i++) D4_fix_int_buf[i] = rank;
    }
    else
        D4_fix_int_buf = NULL;
    ...
    if (nelems_D5 > 0) {
        ...
        for (i = 0; i < nelems_D5; i++) D5_fix_int_buf[i] = rank;
    }
    else
        D5_fix_int_buf = NULL;
    ...
    if (nelems_D1 > 0) {
        ...
        for (i = 0; i < nelems_D1; i++) D1_fix_dbl_buf[i] = rank;
    }
    else
        D1_fix_dbl_buf = NULL;

...
extern int read_decomp (MPI_Comm io_comm,
                        const char *infname,
                        int *num_decomp,
                        MPI_Offset dims[][2],
                        int contig_nreqs[3],
...
extern int def_F_case_h0 (int ncid, const MPI_Offset dims[2], int nvars, int *varids);
extern int inq_F_case_h0 (int ncid,           /* file ID */
                          MPI_Offset dims[2], /* dimension sizes */
                          int nvars,          /* number of variables */
                          int *varids);       /* variable IDs */

extern int def_F_case_h1 (int ncid, const MPI_Offset dims[2], int nvars, int *varids);
extern int inq_F_case_h1 (int ncid,           /* file ID */
                          MPI_Offset dims[2], /* dimension sizes */
                          int nvars,          /* number of variables */
                          int *varids);       /* variable IDs */

extern int run_vard_F_case (
...
extern int def_G_case_h0 (int ncid,                    /* file ID */
                          ...
                          int nvars,                   /* number of variables */
                          int *varids);                /* variable IDs */
extern int inq_G_case_h0 (int ncid,                    /* file ID */

                   ...
                   int            *nvars_decomp)
{
    ...
    DEF_VAR("D1.nreqs", MPI_INT, 1, dimids)
    PUT_ATTR_TXT("description", "Number of noncontiguous requests per blob")
    PUT_ATTR_INT("global_dimids", 1, dimids_D[0]+1)
    DEF_VAR("D1.blob_start", MPI_LONG_LONG, 1, dimids)
    PUT_ATTR_TXT("description", "Starting variable array index per blob")
    DEF_VAR("D1.blob_count", MPI_LONG_LONG, 1, dimids)
    PUT_ATTR_TXT("description", "Number of variable array elements per blob")
    DEF_VAR("D1.offsets", MPI_INT, 2, dimids)
    PUT_ATTR_TXT("description", "Flattened starting indices of noncontiguous requests")
    DEF_VAR("D1.lengths", MPI_INT, 2, dimids)
    PUT_ATTR_TXT("description", "Lengths of noncontiguous requests")

    dimids[1] = max_nreqs_D[1];
    DEF_VAR("D2.nreqs", MPI_INT, 1, dimids)
    PUT_ATTR_TXT("description", "Number of noncontiguous requests per blob")
    PUT_ATTR_INT("global_dimids", 1, dimids_D[1]+1)
    DEF_VAR("D2.blob_start", MPI_LONG_LONG, 1, dimids)
    PUT_ATTR_TXT("description", "Starting variable array index per blob")
    DEF_VAR("D2.blob_count", MPI_LONG_LONG, 1, dimids)
    PUT_ATTR_TXT("description", "Number of variable array elements per blob")
    DEF_VAR("D2.offsets", MPI_INT, 2, dimids)
    PUT_ATTR_TXT("description", "Flattened starting indices of noncontiguous requests")
    DEF_VAR("D2.lengths", MPI_INT, 2, dimids)
    PUT_ATTR_TXT("description", "Lengths of noncontiguous requests")

    dimids[1] = max_nreqs_D[2];
    DEF_VAR("D3.nreqs", MPI_INT, 1, dimids)
    PUT_ATTR_TXT("description", "Number of noncontiguous requests per blob")
    PUT_ATTR_INT("global_dimids", 2, dimids_D[2]+1)
    DEF_VAR("D3.blob_start", MPI_LONG_LONG, 1, dimids)
    PUT_ATTR_TXT("description", "Starting variable array index per blob")
    DEF_VAR("D3.blob_count", MPI_LONG_LONG, 1, dimids)
    PUT_ATTR_TXT("description", "Number of variable array elements per blob")
    DEF_VAR("D3.offsets", MPI_INT, 2, dimids)
    PUT_ATTR_TXT("description", "Flattened starting indices of noncontiguous requests")
    DEF_VAR("D3.lengths", MPI_INT, 2, dimids)
    PUT_ATTR_TXT("description", "Lengths of noncontiguous requests")

...
#define PUT_ATT_INT(F, D, N, T, S, B)   driver.put_att (F, D, N, MPI_INT, S, (int *)B);
...
static int define_global_attributes (e3sm_io_driver &driver, int ncid) {
    ...
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_restart_timestamp_name", 12,
                        "rpointer.ocn");
    CHECK_ERR
    ...
    CHECK_ERR
    err =
        PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_run_duration", 19, "0001-00-00_00:00:00");
    CHECK_ERR
    ...
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_proc_decomp_file_prefix", 16,
                        "graph.info.part.");
    CHECK_ERR
    iattr = -1;
    ...
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_vert_coord_movement", 18,
                        "uniform_stretching");
    CHECK_ERR
    ...
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_cvmix_kpp_interpolationOMLType", 9,
                        "quadratic");
    CHECK_ERR
    dattr = 0.1;
    ...
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_cvmix_kpp_nonlocal_with_implicit_mix", 2,
                        "NO");
    CHECK_ERR
    ...
    CHECK_ERR
    err =
        PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_land_ice_flux_mode", 13, "pressure_only");
    CHECK_ERR
    err =
        PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_land_ice_flux_formulation", 7, "Jenkins");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_land_ice_flux_useHollandJenkinsAdvDiff",
                        2, "NO");
    CHECK_ERR
    dattr = 10.;
    ...
    CHECK_ERR
    err =
        PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_tensor_test_function", 11, "sph_uCosCos");
    CHECK_ERR
    ...
    CHECK_ERR
    err =
        PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_compute_active_tracer_budgets", 3, "YES");
    CHECK_ERR
    ...
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_disable_vel_explicit_bottom_drag", 2,
                        "NO");
    CHECK_ERR
    ...
    CHECK_ERR
    err =
        PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_global_ocean_temperature_file", 4, "none");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_global_ocean_salinity_file", 4, "none");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_global_ocean_tracer_nlat_dimname", 4,
                        "none");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_global_ocean_tracer_nlon_dimname", 4,
                        "none");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_global_ocean_tracer_ndepth_dimname", 4,
                        "none");
    CHECK_ERR
    dattr = 1.;
    err   = driver.put_att (ncid, E3SM_IO_GLOBAL_ATTR,
    ...
    CHECK_ERR
    err =
        PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_global_ocean_salinity_varname", 4, "none");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_global_ocean_tracer_latlon_degrees", 3,
                        "YES");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_global_ocean_tracer_lat_varname", 4,
                        "none");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_global_ocean_tracer_lon_varname", 4,
                        "none");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_global_ocean_tracer_depth_varname", 4,
                        "none");
    CHECK_ERR
    ...
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_global_ocean_swData_nlat_dimname", 4,
                        "none");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_global_ocean_swData_nlon_dimname", 4,
                        "none");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_global_ocean_swData_lat_varname", 4,
                        "none");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_global_ocean_swData_lon_varname", 4,
                        "none");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_global_ocean_swData_latlon_degrees", 3,
                        "YES");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_global_ocean_swData_method", 22,
                        "bilinear_interpolation");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_global_ocean_chlorophyll_varname", 4,
                        "none");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_global_ocean_zenithAngle_varname", 4,
                        "none");
    CHECK_ERR
    err =
    ...
    CHECK_ERR
    err =
        PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_global_ocean_topography_file", 4, "none");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_global_ocean_topography_nlat_dimname", 4,
                        "none");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_global_ocean_topography_nlon_dimname", 4,
                        "none");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_global_ocean_topography_latlon_degrees",
                        3, "YES");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_global_ocean_topography_lat_varname", 4,
                        "none");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_global_ocean_topography_lon_varname", 4,
                        "none");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_global_ocean_topography_varname", 4,
                        "none");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_global_ocean_topography_has_ocean_frac",
                        2, "NO");
    CHECK_ERR
    ...
    CHECK_ERR
    err =
        PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_global_ocean_smooth_topography", 3, "YES");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_global_ocean_deepen_critical_passages",
                        3, "YES");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_global_ocean_depress_by_land_ice", 2,
                        "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_global_ocean_land_ice_topo_file", 4,
                        "none");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_global_ocean_land_ice_topo_nlat_dimname",
                        4, "none");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_global_ocean_land_ice_topo_nlon_dimname",
                        4, "none");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR,
                        "config_global_ocean_land_ice_topo_latlon_degrees", 3, "YES");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_global_ocean_land_ice_topo_lat_varname",
                        4, "none");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_global_ocean_land_ice_topo_lon_varname",
                        4, "none");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR,
    ...
    CHECK_ERR
    err =
        PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_global_ocean_cull_inland_seas", 3, "YES");
    CHECK_ERR
    err =
        PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_global_ocean_windstress_file", 4, "none");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_global_ocean_windstress_nlat_dimname", 4,
                        "none");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_global_ocean_windstress_nlon_dimname", 4,
                        "none");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_global_ocean_windstress_latlon_degrees",
                        3, "YES");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_global_ocean_windstress_lat_varname", 4,
                        "none");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_global_ocean_windstress_lon_varname", 4,
                        "none");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_global_ocean_windstress_zonal_varname",
                        4, "none");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR,
    ...
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_global_ocean_ecosys_forcing_file", 7,
                        "unknown");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_global_ocean_ecosys_nlat_dimname", 4,
                        "none");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_global_ocean_ecosys_nlon_dimname", 4,
                        "none");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_global_ocean_ecosys_ndepth_dimname", 4,
                        "none");
    CHECK_ERR
    dattr = 1.;
    err   = driver.put_att (ncid, E3SM_IO_GLOBAL_ATTR,
    ...
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_global_ocean_ecosys_lat_varname", 4,
                        "none");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_global_ocean_ecosys_lon_varname", 4,
                        "none");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_global_ocean_ecosys_depth_varname", 4,
                        "none");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_global_ocean_ecosys_latlon_degrees", 3,
                        "YES");
    CHECK_ERR
    ...
    CHECK_ERR
    err =
        PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_ecosys_column_TS_filename", 7, "unknown");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_ecosys_column_ecosys_filename", 7,
                        "unknown");
    CHECK_ERR
    dattr = 6000.;
    ...
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_sea_mount_stratification_type", 11,
                        "exponential");
    CHECK_ERR
    dattr = 1024.;
    ...
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_use_activeTracers_surface_bulk_forcing",
                        3, "YES");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_use_activeTracers_surface_restoring", 3,
                        "YES");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_use_activeTracers_interior_restoring", 2,
                        "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_use_activeTracers_exponential_decay", 2,
                        "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_use_activeTracers_idealAge_forcing", 2,
                        "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_use_activeTracers_ttd_forcing", 2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_use_surface_salinity_monthly_restoring",
                        3, "YES");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR,
    ...
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_use_debugTracers_surface_bulk_forcing",
                        2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_use_debugTracers_surface_restoring", 2,
                        "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_use_debugTracers_interior_restoring", 2,
                        "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_use_debugTracers_exponential_decay", 2,
                        "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_use_debugTracers_idealAge_forcing", 2,
                        "NO");
    CHECK_ERR
    ...
    CHECK_ERR
    err =
        PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_ecosys_atm_alt_co2_option", 8, "constant");
    CHECK_ERR
    ...
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_use_ecosysTracers_surface_bulk_forcing",
                        2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_use_ecosysTracers_surface_restoring", 2,
                        "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_use_ecosysTracers_interior_restoring", 2,
                        "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_use_ecosysTracers_exponential_decay", 2,
                        "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_use_ecosysTracers_idealAge_forcing", 2,
                        "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_use_ecosysTracers_ttd_forcing", 2, "NO");
    CHECK_ERR
    err =
        PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_use_ecosysTracers_surface_value", 2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_use_ecosysTracers_sea_ice_coupling", 2,
                        "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_ecosysTracers_diagnostic_fields_level1",
                        2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_ecosysTracers_diagnostic_fields_level2",
                        2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_ecosysTracers_diagnostic_fields_level3",
                        2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_ecosysTracers_diagnostic_fields_level4",
                        2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_ecosysTracers_diagnostic_fields_level5",
                        2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_use_DMSTracers", 2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_use_DMSTracers_surface_bulk_forcing", 2,
                        "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_use_DMSTracers_surface_restoring", 2,
                        "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_use_DMSTracers_interior_restoring", 2,
                        "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_use_DMSTracers_exponential_decay", 2,
                        "NO");
    CHECK_ERR
    err =
        PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_use_DMSTracers_idealAge_forcing", 2, "NO");
    CHECK_ERR
    ...
    CHECK_ERR
    err =
        PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_use_DMSTracers_sea_ice_coupling", 2, "NO");
    CHECK_ERR
    ...
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_use_MacroMoleculesTracers_ttd_forcing",
                        2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_use_MacroMoleculesTracers_surface_value",
                        2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR,
    ...
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_globalStats_compute_interval", 15,
                        "output_interval");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_globalStats_compute_on_startup", 3,
                        "YES");
    CHECK_ERR
    err =
        PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_globalStats_write_on_startup", 2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_globalStats_text_file", 2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_globalStats_directory", 16,
                        "analysis_members");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_globalStats_output_stream", 17,
                        "globalStatsOutput");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_surfaceAreaWeightedAverages_enable",
                        3, "YES");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR,
    ...
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_waterMassCensus_compute_on_startup",
                        3, "YES");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_waterMassCensus_write_on_startup", 2,
                        "NO");
    CHECK_ERR
    dattr = -2.;
    ...
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_layerVolumeWeightedAverage_enable", 3,
                        "YES");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR,
    ...
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_zonalMean_compute_on_startup", 3,
                        "YES");
    CHECK_ERR
    ...
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_zonalMean_compute_interval", 19,
                        "0000-00-00_01:00:00");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_zonalMean_output_stream", 15,
                        "zonalMeanOutput");
    CHECK_ERR
    iattr = 180;
    ...
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_okuboWeiss_compute_on_startup", 3,
                        "YES");
    CHECK_ERR
    err =
        PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_okuboWeiss_write_on_startup", 2, "NO");
    CHECK_ERR
    ...
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_okuboWeiss_output_stream", 16,
                        "okuboWeissOutput");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_okuboWeiss_directory", 16,
                        "analysis_members");
    CHECK_ERR
    dattr = -0.2;
    ...
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_okuboWeiss_use_lat_lon_coords", 3,
                        "YES");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_okuboWeiss_compute_eddy_census", 3,
                        "YES");
    CHECK_ERR
    iattr = 20;
    ...
    CHECK_ERR
    err =
        PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_meridionalHeatTransport_output_stream",
    ...
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_testComputeInterval_compute_interval",
                        17, "00-00-01_00:00:00");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR,
                        "config_AM_testComputeInterval_compute_on_startup", 3, "YES");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_testComputeInterval_write_on_startup",
                        2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_testComputeInterval_output_stream",
                        25, "testComputeIntervalOutput");
    CHECK_ERR
    err =
        PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_highFrequencyOutput_enable", 3, "YES");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_highFrequencyOutput_compute_interval",
                        15, "output_interval");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_highFrequencyOutput_output_stream",
                        19, "highFrequencyOutput");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR,
                        "config_AM_highFrequencyOutput_compute_on_startup", 2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_highFrequencyOutput_write_on_startup",
                        2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_timeFilters_enable", 2, "NO");
    CHECK_ERR
    err =
        PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_timeFilters_compute_interval", 2, "dt");
    CHECK_ERR
    ...
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_timeFilters_restart_stream", 18,
                        "timeFiltersRestart");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_timeFilters_compute_on_startup", 3,
                        "YES");
    CHECK_ERR
    err =
        PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_timeFilters_write_on_startup", 2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_timeFilters_initialize_filters", 3,
                        "YES");
    CHECK_ERR
    ...
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_lagrPartTrack_compute_interval", 2,
                        "dt");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_lagrPartTrack_compute_on_startup", 2,
                        "NO");
    CHECK_ERR
    ...
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_lagrPartTrack_input_stream", 18,
                        "lagrPartTrackInput");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_lagrPartTrack_write_on_startup", 2,
                        "NO");
    CHECK_ERR
    iattr = 0;
    ...
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_lagrPartTrack_reset_criteria", 4,
                        "none");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_lagrPartTrack_reset_global_timestamp",
                        13, "0000_00:00:00");
    CHECK_ERR
    ...
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_lagrPartTrack_reset_if_inside_region",
                        2, "NO");
    CHECK_ERR
    ...
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_eliassenPalm_restart_stream", 19,
                        "eliassenPalmRestart");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_eliassenPalm_compute_on_startup", 3,
                        "YES");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_eliassenPalm_write_on_startup", 2,
                        "NO");
    CHECK_ERR
    ...
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_mixedLayerDepths_compute_interval",
    ...
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_mixedLayerDepths_write_on_startup", 2,
                        "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_mixedLayerDepths_compute_on_startup",
                        3, "YES");
    CHECK_ERR
    err =
        PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_mixedLayerDepths_Tthreshold", 3, "YES");
    CHECK_ERR
    err =
    ...
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_regionalStatsDaily_write_on_startup",
                        2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_regionalStatsDaily_compute_interval",
                        15, "output_interval");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_regionalStatsDaily_output_stream", 24,
                        "regionalStatsDailyOutput");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_regionalStatsDaily_restart_stream",
                        18, "regionalMasksInput");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_regionalStatsDaily_input_stream", 18,
                        "regionalMasksInput");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_regionalStatsDaily_operation", 3,
                        "avg");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_regionalStatsDaily_region_type", 4,
                        "cell");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_regionalStatsDaily_region_group", 3,
                        "all");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR,
    ...
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_regionalStatsDaily_vertical_mask", 8,
                        "cellMask");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR,
    ...
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_regionalStatsWeekly_write_on_startup",
                        2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_regionalStatsWeekly_compute_interval",
                        15, "output_interval");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_regionalStatsWeekly_output_stream",
                        25, "regionalStatsWeeklyOutput");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_regionalStatsWeekly_restart_stream",
                        18, "regionalMasksInput");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_regionalStatsWeekly_input_stream", 18,
                        "regionalMasksInput");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_regionalStatsWeekly_operation", 3,
                        "avg");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_regionalStatsWeekly_region_type", 4,
                        "cell");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_regionalStatsWeekly_region_group", 3,
                        "all");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR,
    ...
    CHECK_ERR
    err =
        PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_regionalStatsMonthly_enable", 2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR,
    ...
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_regionalStatsMonthly_output_stream",
                        26, "regionalStatsMonthlyOutput");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_regionalStatsMonthly_restart_stream",
                        18, "regionalMasksInput");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_regionalStatsMonthly_input_stream",
                        18, "regionalMasksInput");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_regionalStatsMonthly_operation", 3,
                        "avg");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_regionalStatsMonthly_region_type", 4,
                        "cell");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_regionalStatsMonthly_region_group", 3,
                        "all");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR,
    ...
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_regionalStatsMonthly_vertical_mask",
                        8, "cellMask");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR,
    ...
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_regionalStatsCustom_write_on_startup",
                        2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_regionalStatsCustom_compute_interval",
                        15, "output_interval");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_regionalStatsCustom_output_stream",
                        25, "regionalStatsCustomOutput");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_regionalStatsCustom_restart_stream",
                        18, "regionalMasksInput");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_regionalStatsCustom_input_stream", 18,
                        "regionalMasksInput");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_regionalStatsCustom_operation", 3,
                        "avg");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_regionalStatsCustom_region_type", 4,
                        "cell");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_regionalStatsCustom_region_group", 3,
                        "all");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR,
    ...
    CHECK_ERR
    err =
        PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_timeSeriesStatsDaily_enable", 2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR,
    ...
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_timeSeriesStatsDaily_output_stream",
                        26, "timeSeriesStatsDailyOutput");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_timeSeriesStatsDaily_restart_stream",
                        4, "none");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_timeSeriesStatsDaily_operation", 3,
                        "avg");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_timeSeriesStatsDaily_reference_times",
                        12, "initial_time");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR,
    ...
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_timeSeriesStatsDaily_reset_intervals",
                        17, "00-00-01_00:00:00");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR,
                        ...
                        "00-00-01_00:00:00");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_timeSeriesStatsMonthly_enable", 3,
                        "YES");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR,
    ...
    CHECK_ERR
    err =
        PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR,
                      "config_AM_timeSeriesStatsMonthly_compute_interval", 17, "00-00-00_01:00:00");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_timeSeriesStatsMonthly_output_stream",
                        28, "timeSeriesStatsMonthlyOutput");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR,
                        "config_AM_timeSeriesStatsMonthly_restart_stream", 4, "none");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_timeSeriesStatsMonthly_operation", 3,
                        "avg");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR,
    ...
    CHECK_ERR
    err =
        PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_timeSeriesStatsMonthly_reset_intervals",
    ...
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR,
                        ...
                        "00-01-00_00:00:00");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_timeSeriesStatsClimatology_enable", 2,
                        "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR,
    ...
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_timeSeriesStatsClimatology_operation",
                        3, "avg");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR,
    ...
    CHECK_ERR
    err =
        PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_timeSeriesStatsCustom_enable", 2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR,
    ...
    CHECK_ERR
    err =
        PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_timeSeriesStatsCustom_compute_interval",
                      17, "00-00-00_01:00:00");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_timeSeriesStatsCustom_output_stream",
                        27, "timeSeriesStatsCustomOutput");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_timeSeriesStatsCustom_restart_stream",
                        28, "timeSeriesStatsCustomRestart");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_timeSeriesStatsCustom_operation", 3,
                        "avg");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR,
    ...
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_pointwiseStats_compute_on_startup", 3,
                        "YES");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_pointwiseStats_write_on_startup", 2,
                        "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_debugDiagnostics_enable", 2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_debugDiagnostics_compute_interval", 2,
                        "dt");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_debugDiagnostics_output_stream", 22,
                        "debugDiagnosticsOutput");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_debugDiagnostics_compute_on_startup",
                        3, "YES");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_debugDiagnostics_write_on_startup", 2,
                        "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_debugDiagnostics_check_state", 3,
                        "YES");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_rpnCalculator_enable", 2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_rpnCalculator_compute_on_startup", 3,
                        "YES");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_rpnCalculator_write_on_startup", 2,
                        "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_rpnCalculator_compute_interval", 19,
                        "0010-00-00_00:00:00");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_rpnCalculator_output_stream", 4,
                        "none");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_rpnCalculator_variable_a", 14,
                        "layerThickness");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_rpnCalculator_variable_b", 8,
                        "areaCell");
    CHECK_ERR
    ...
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_rpnCalculator_expression_1", 5,
                        "a b *");
    CHECK_ERR
    err =
        PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_rpnCalculator_expression_2", 4, "none");
    CHECK_ERR
    err =
        PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_rpnCalculator_expression_3", 4, "none");
    CHECK_ERR
    err =
        PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_rpnCalculator_expression_4", 4, "none");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_rpnCalculator_output_name_1", 10,
                        "volumeCell");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_rpnCalculator_output_name_2", 4,
                        "none");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_rpnCalculator_output_name_3", 4,
                        "none");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_rpnCalculator_output_name_4", 4,
                        "none");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_transectTransport_enable", 2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_transectTransport_compute_interval",
                        15, "output_interval");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_transectTransport_output_stream", 23,
                        "transectTransportOutput");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_transectTransport_compute_on_startup",
                        3, "YES");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_transectTransport_write_on_startup",
                        2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_transectTransport_transect_group", 3,
                        "all");
    CHECK_ERR
    err =
        PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_eddyProductVariables_enable", 3, "YES");
    CHECK_ERR
    err =
        PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_eddyProductVariables_compute_interval",
                      19, "0000-00-00_01:00:00");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_eddyProductVariables_output_stream",
    ...
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_mocStreamfunction_compute_interval",
                        19, "0000-00-00_01:00:00");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_mocStreamfunction_output_stream", 23,
                        "mocStreamfunctionOutput");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_mocStreamfunction_compute_on_startup",
                        3, "YES");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_mocStreamfunction_write_on_startup",
                        2, "NO");
    CHECK_ERR
    dattr = -1.e+34;
    ...
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_mocStreamfunction_region_group", 3,
                        "all");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, E3SM_IO_GLOBAL_ATTR, "config_AM_mocStreamfunction_transect_group", 3,
                        "all");
    CHECK_ERR
                   ...
                   int *varids)                 /* variable IDs */
{
    ...
    err = driver.def_var (ncid, "salinitySurfaceRestoringTendency", MPI_DOUBLE, 2, dimids,
    ...
    err = driver.def_var (ncid, "vertTransportVelocityTop", MPI_DOUBLE, 3, dimids,
    ...
    err = driver.def_var (ncid, "vertGMBolusVelocityTop", MPI_DOUBLE, 3, dimids,
    ...
    err = driver.def_var (ncid, "vertAleTransportTop", MPI_DOUBLE, 3, dimids, &vertAleTransportTop);
    CHECK_ERR
    ...
    err = driver.def_var (ncid, "tendSSH", MPI_DOUBLE, 2, dimids, &tendSSH);
    CHECK_ERR
    ...
    err = driver.def_var (ncid, "layerThickness", MPI_DOUBLE, 3, dimids, &layerThickness);
    CHECK_ERR
    ...
    err = driver.def_var (ncid, "normalVelocity", MPI_DOUBLE, 3, dimids, &normalVelocity);
    CHECK_ERR
    ...
    err = driver.def_var (ncid, "ssh", MPI_DOUBLE, 2, dimids, &ssh);
    CHECK_ERR
    ...
    err = driver.def_var (ncid, "maxLevelEdgeTop", MPI_INT, 1, dimids, &maxLevelEdgeTop);
    CHECK_ERR
    ...
    err = driver.def_var (ncid, "vertCoordMovementWeights", MPI_DOUBLE, 1, dimids,
    ...
    err = driver.def_var (ncid, "edgeMask", MPI_INT, 2, dimids, &edgeMask);
    CHECK_ERR
    ...
    err = driver.def_var (ncid, "cellMask", MPI_INT, 2, dimids, &cellMask);
    CHECK_ERR
    ...
    err = driver.def_var (ncid, "vertexMask", MPI_INT, 2, dimids, &vertexMask);
    CHECK_ERR
    ...
    err = driver.def_var (ncid, "refZMid", MPI_DOUBLE, 1, dimids, &refZMid);
    CHECK_ERR
    ...
    err = driver.def_var (ncid, "refLayerThickness", MPI_DOUBLE, 1, dimids, &refLayerThickness);
    CHECK_ERR
    ...
    err = driver.def_var (ncid, "xtime", MPI_CHAR, 2, dimids, &xtime);
    CHECK_ERR
    ...
    err = driver.def_var (ncid, "kineticEnergyCell", MPI_DOUBLE, 3, dimids, &kineticEnergyCell);
    CHECK_ERR
    ...
    err = driver.def_var (ncid, "relativeVorticityCell", MPI_DOUBLE, 3, dimids,
    ...
    err = driver.def_var (ncid, "relativeVorticity", MPI_DOUBLE, 3, dimids, &relativeVorticity);
    CHECK_ERR
    ...
    err = driver.def_var (ncid, "divergence", MPI_DOUBLE, 3, dimids, &divergence);
    CHECK_ERR
    ...
    err = driver.def_var (ncid, "areaCellGlobal", MPI_DOUBLE, 1, dimids, &areaCellGlobal);
    CHECK_ERR
    ...
    err = driver.def_var (ncid, "areaEdgeGlobal", MPI_DOUBLE, 1, dimids, &areaEdgeGlobal);
    CHECK_ERR
    ...
    err = driver.def_var (ncid, "areaTriangleGlobal", MPI_DOUBLE, 1, dimids, &areaTriangleGlobal);
    CHECK_ERR
    ...
    err = driver.def_var (ncid, "volumeCellGlobal", MPI_DOUBLE, 1, dimids, &volumeCellGlobal);
    CHECK_ERR
    ...
    err = driver.def_var (ncid, "volumeEdgeGlobal", MPI_DOUBLE, 1, dimids, &volumeEdgeGlobal);
    CHECK_ERR
    ...
    err = driver.def_var (ncid, "CFLNumberGlobal", MPI_DOUBLE, 1, dimids, &CFLNumberGlobal);
    CHECK_ERR
    ...
    err = driver.def_var (ncid, "BruntVaisalaFreqTop", MPI_DOUBLE, 3, dimids, &BruntVaisalaFreqTop);
    CHECK_ERR
    ...
    err = driver.def_var (ncid, "vertVelocityTop", MPI_DOUBLE, 3, dimids, &vertVelocityTop);
    CHECK_ERR
    ...
    err = driver.def_var (ncid, "velocityZonal", MPI_DOUBLE, 3, dimids, &velocityZonal);
    CHECK_ERR
    ...
    err = driver.def_var (ncid, "velocityMeridional", MPI_DOUBLE, 3, dimids, &velocityMeridional);
    CHECK_ERR
    ...
    err = driver.def_var (ncid, "displacedDensity", MPI_DOUBLE, 3, dimids, &displacedDensity);
    CHECK_ERR
    ...
    err = driver.def_var (ncid, "potentialDensity", MPI_DOUBLE, 3, dimids, &potentialDensity);
    CHECK_ERR
    ...
    err = driver.def_var (ncid, "pressure", MPI_DOUBLE, 3, dimids, &pressure);
    CHECK_ERR
    ...
    err = driver.def_var (ncid, "refBottomDepth", MPI_DOUBLE, 1, dimids, &refBottomDepth);
    CHECK_ERR
    ...
    err = driver.def_var (ncid, "zMid", MPI_DOUBLE, 3, dimids, &zMid);
    CHECK_ERR
    ...
    err = driver.def_var (ncid, "bottomDepth", MPI_DOUBLE, 1, dimids, &bottomDepth);
    CHECK_ERR
    ...
    err = driver.def_var (ncid, "maxLevelCell", MPI_INT, 1, dimids, &maxLevelCell);
    CHECK_ERR
    ...
    err = driver.def_var (ncid, "maxLevelEdgeBot", MPI_INT, 1, dimids, &maxLevelEdgeBot);
    CHECK_ERR
    ...
    err = driver.def_var (ncid, "columnIntegratedSpeed", MPI_DOUBLE, 2, dimids,
    ...
    err = driver.def_var (ncid, "temperatureHorizontalAdvectionTendency", MPI_DOUBLE, 3, dimids,
    ...
    err = driver.def_var (ncid, "salinityHorizontalAdvectionTendency", MPI_DOUBLE, 3, dimids,
    ...
    err = driver.def_var (ncid, "temperatureVerticalAdvectionTendency", MPI_DOUBLE, 3, dimids,
    ...
    err = driver.def_var (ncid, "salinityVerticalAdvectionTendency", MPI_DOUBLE, 3, dimids,
    ...
    err = driver.def_var (ncid, "temperatureVertMixTendency", MPI_DOUBLE, 3, dimids,
    ...
    err = driver.def_var (ncid, "salinityVertMixTendency", MPI_DOUBLE, 3, dimids,
    ...
    err = driver.def_var (ncid, "temperatureSurfaceFluxTendency", MPI_DOUBLE, 3, dimids,
    ...
    err = driver.def_var (ncid, "salinitySurfaceFluxTendency", MPI_DOUBLE, 3, dimids,
    ...
    err = driver.def_var (ncid, "temperatureShortWaveTendency", MPI_DOUBLE, 3, dimids,
    ...
    err = driver.def_var (ncid, "temperatureNonLocalTendency", MPI_DOUBLE, 3, dimids,
    ...
    err = driver.def_var (ncid, "salinityNonLocalTendency", MPI_DOUBLE, 3, dimids,
    ...
    err = driver.def_var (ncid, "temperature", MPI_DOUBLE, 3, dimids, &temperature);
    CHECK_ERR
    ...
    err = driver.def_var (ncid, "salinity", MPI_DOUBLE, 3, dimids, &salinity);
    CHECK_ERR

                         ...
                         int *int_buf)        /* buffer for int var */
{
    ...
    if (cfg.nvars == 416)
        rec_buflen = nelems[1] * 325 + nelems[2] * 63 + (321 + 63) * gap;
    else
    ...
    if (cfg.nvars == 416) {
        ...
        ASSIGN_DECOMID (2, 38, 169)  /* SFDMS ... SNOWHLND */
        ASSIGN_DECOMID (3, 2, 207)   /* SNOWQM and SO2 */
        ASSIGN_DECOMID (2, 10, 209)  /* SO2_CLXF ... SWCF */
        ASSIGN_DECOMID (3, 1, 219)   /* T */
        ASSIGN_DECOMID (2, 20, 220)  /* TAUGWX ... TVQ */
        ASSIGN_DECOMID (3, 1, 240)   /* U */
        ASSIGN_DECOMID (2, 1, 241)   /* U10 */
        ASSIGN_DECOMID (3, 6, 242)   /* UU ... VV */
        ASSIGN_DECOMID (2, 3, 248)   /* WD_H2O2 ... WD_SO2 */
        ASSIGN_DECOMID (3, 3, 251)   /* WSUB ... aero_water */
        ASSIGN_DECOMID (2, 32, 254)  /* airFV ... dst_c3SFWET */
        ASSIGN_DECOMID (3, 1, 286)   /* hstobie_linoz */
        ASSIGN_DECOMID (2, 129, 287) /* mlip ... soa_c3SFWET */
    } else {

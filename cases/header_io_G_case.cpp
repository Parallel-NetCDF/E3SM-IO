...
static int define_global_attributes (e3sm_io_driver &driver, int ncid) {
    ...
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "core_name", 5, "ocean");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "history", 28, "mpirun -n 9600 ./ocean_model");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "source", 4, "MPAS");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "Conventions", 4, "MPAS");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "parent_id", 65,
                        "mt6vdoeok9\nrz1tbn0bed\n555vk5hkh9\n0s1lcmezuy\n7z1uysqc5i\nwj661vqvze");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "mesh_spec", 3, "0.0");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "git_version", 16, "MPAS_GIT_VERSION");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_ocean_run_mode", 7, "forward");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_do_restart", 2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_restart_timestamp_name", 12, "rpointer.ocn");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_start_time", 19, "0001-01-01_00:00:00");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_stop_time", 4, "none");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_run_duration", 19, "0001-00-00_00:00:00");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_calendar_type", 16, "gregorian_noleap");
    CHECK_ERR
    ...
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_expand_sphere", 2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_realistic_coriolis_parameter", 2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_write_cull_cell_mask", 3, "YES");
    CHECK_ERR
    ...
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_dt", 8, "00:06:00");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_time_integrator", 14, "split_explicit");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_vert_coord_movement", 18, "uniform_stretching");
    CHECK_ERR
    ...
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_use_freq_filtered_thickness", 2, "NO");
    CHECK_ERR
    dattr = 5.;
    err =
    ...
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_use_cvmix_double_diffusion", 2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_use_cvmix_kpp", 3, "YES");
    CHECK_ERR
    ...
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_cvmix_kpp_EkmanOBL", 2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_cvmix_kpp_MonObOBL", 2, "NO");
    CHECK_ERR
    ...
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_cvmix_kpp_nonlocal_with_implicit_mix", 2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_use_const_visc", 2, "NO");
    CHECK_ERR
    ...
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_frazil_in_open_ocean", 3, "YES");
    CHECK_ERR
    ...
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_land_ice_flux_mode", 13, "pressure_only");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_land_ice_flux_formulation", 7, "Jenkins");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_land_ice_flux_useHollandJenkinsAdvDiff", 2, "NO");
    CHECK_ERR
    dattr = 10.;
    ...
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_use_implicit_bottom_drag", 3, "YES");
    CHECK_ERR
    dattr = 0.001;
    err =
    ...
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_conduct_tests", 2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_test_tensors", 2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_tensor_test_function", 11, "sph_uCosCos");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_disable_redi_k33", 3, "YES");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_disable_redi_horizontal_term1", 2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_disable_redi_horizontal_term2", 2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_disable_redi_horizontal_term3", 2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_check_zlevel_consistency", 2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_check_ssh_consistency", 3, "YES");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_filter_btr_mode", 2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_prescribe_velocity", 2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_prescribe_thickness", 2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_include_KE_vertex", 3, "YES");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_check_tracer_monotonicity", 2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_compute_active_tracer_budgets", 3, "YES");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_disable_thick_all_tend", 2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_disable_thick_hadv", 2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_disable_thick_vadv", 2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_disable_thick_sflux", 2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_disable_vel_all_tend", 2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_disable_vel_coriolis", 2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_disable_vel_pgrad", 2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_disable_vel_hmix", 2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_disable_vel_surface_stress", 2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_disable_vel_explicit_bottom_drag", 2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_disable_vel_vmix", 2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_disable_vel_vadv", 2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_disable_tr_all_tend", 2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_disable_tr_adv", 2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_disable_tr_hmix", 2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_disable_tr_vmix", 2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_disable_tr_sflux", 2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_disable_tr_nonlocalflux", 2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_read_nearest_restart", 2, "NO");
    CHECK_ERR
    ...
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_global_ocean_depth_dimname", 4, "none");
    CHECK_ERR
    ...
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_global_ocean_salinity_file", 4, "none");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_global_ocean_tracer_nlat_dimname", 4, "none");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_global_ocean_tracer_nlon_dimname", 4, "none");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_global_ocean_tracer_ndepth_dimname", 4, "none");
    CHECK_ERR
    dattr = 1.;
    ...
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_global_ocean_salinity_varname", 4, "none");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_global_ocean_tracer_latlon_degrees", 3, "YES");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_global_ocean_tracer_lat_varname", 4, "none");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_global_ocean_tracer_lon_varname", 4, "none");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_global_ocean_tracer_depth_varname", 4, "none");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_global_ocean_tracer_method", 22,
    ...
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_global_ocean_swData_nlat_dimname", 4, "none");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_global_ocean_swData_nlon_dimname", 4, "none");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_global_ocean_swData_lat_varname", 4, "none");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_global_ocean_swData_lon_varname", 4, "none");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_global_ocean_swData_latlon_degrees", 3, "YES");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_global_ocean_swData_method", 22,
                        "bilinear_interpolation");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_global_ocean_chlorophyll_varname", 4, "none");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_global_ocean_zenithAngle_varname", 4, "none");
    CHECK_ERR
    ...
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_global_ocean_topography_nlat_dimname", 4, "none");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_global_ocean_topography_nlon_dimname", 4, "none");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_global_ocean_topography_latlon_degrees", 3, "YES");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_global_ocean_topography_lat_varname", 4, "none");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_global_ocean_topography_lon_varname", 4, "none");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_global_ocean_topography_varname", 4, "none");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_global_ocean_topography_has_ocean_frac", 2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_global_ocean_topography_ocean_frac_varname", 4,
                        "none");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_global_ocean_topography_method", 22,
                        "bilinear_interpolation");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_global_ocean_smooth_topography", 3, "YES");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_global_ocean_deepen_critical_passages", 3, "YES");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_global_ocean_depress_by_land_ice", 2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_global_ocean_land_ice_topo_file", 4, "none");
    CHECK_ERR
    err =
        PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_global_ocean_land_ice_topo_nlat_dimname", 4, "none");
    CHECK_ERR
    err =
        PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_global_ocean_land_ice_topo_nlon_dimname", 4, "none");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_global_ocean_land_ice_topo_latlon_degrees", 3,
                        "YES");
    CHECK_ERR
    err =
        PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_global_ocean_land_ice_topo_lat_varname", 4, "none");
    CHECK_ERR
    err =
        PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_global_ocean_land_ice_topo_lon_varname", 4, "none");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_global_ocean_land_ice_topo_thickness_varname", 4,
                        "none");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_global_ocean_land_ice_topo_draft_varname", 4,
                        "none");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_global_ocean_land_ice_topo_ice_frac_varname", 4,
                        "none");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_global_ocean_land_ice_topo_grounded_frac_varname",
                        4, "none");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL,
    ...
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_global_ocean_windstress_file", 4, "none");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_global_ocean_windstress_nlat_dimname", 4, "none");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_global_ocean_windstress_nlon_dimname", 4, "none");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_global_ocean_windstress_latlon_degrees", 3, "YES");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_global_ocean_windstress_lat_varname", 4, "none");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_global_ocean_windstress_lon_varname", 4, "none");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_global_ocean_windstress_zonal_varname", 4, "none");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_global_ocean_windstress_meridional_varname", 4,
                        "none");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_global_ocean_windstress_method", 22,
                        "bilinear_interpolation");
    CHECK_ERR
    dattr = 1.;
    ...
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_global_ocean_ecosys_forcing_file", 7, "unknown");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_global_ocean_ecosys_nlat_dimname", 4, "none");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_global_ocean_ecosys_nlon_dimname", 4, "none");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_global_ocean_ecosys_ndepth_dimname", 4, "none");
    CHECK_ERR
    dattr = 1.;
    ...
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_global_ocean_ecosys_lon_varname", 4, "none");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_global_ocean_ecosys_depth_varname", 4, "none");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_global_ocean_ecosys_latlon_degrees", 3, "YES");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_global_ocean_ecosys_method", 22,
                        "bilinear_interpolation");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_global_ocean_ecosys_forcing_time_dimname", 4,
                        "none");
    CHECK_ERR
    iattr = 0;
    ...
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_ecosys_column_TS_filename", 7, "unknown");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_ecosys_column_ecosys_filename", 7, "unknown");
    CHECK_ERR
    dattr = 6000.;
    err =
    ...
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_use_activeTracers_surface_bulk_forcing", 3, "YES");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_use_activeTracers_surface_restoring", 3, "YES");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_use_activeTracers_interior_restoring", 2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_use_activeTracers_exponential_decay", 2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_use_activeTracers_idealAge_forcing", 2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_use_activeTracers_ttd_forcing", 2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_use_surface_salinity_monthly_restoring", 3, "YES");
    CHECK_ERR
    err =
        PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_surface_salinity_monthly_restoring_compute_interval",
    ...
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_use_debugTracers", 2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_use_debugTracers_surface_bulk_forcing", 2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_use_debugTracers_surface_restoring", 2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_use_debugTracers_interior_restoring", 2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_use_debugTracers_exponential_decay", 2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_use_debugTracers_idealAge_forcing", 2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_use_debugTracers_ttd_forcing", 2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_use_ecosysTracers", 2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_ecosys_atm_co2_option", 8, "constant");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_ecosys_atm_alt_co2_option", 8, "constant");
    CHECK_ERR
    ...
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_use_ecosysTracers_surface_restoring", 2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_use_ecosysTracers_interior_restoring", 2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_use_ecosysTracers_exponential_decay", 2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_use_ecosysTracers_idealAge_forcing", 2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_use_ecosysTracers_ttd_forcing", 2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_use_ecosysTracers_surface_value", 2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_use_ecosysTracers_sea_ice_coupling", 2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_ecosysTracers_diagnostic_fields_level1", 2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_ecosysTracers_diagnostic_fields_level2", 2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_ecosysTracers_diagnostic_fields_level3", 2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_ecosysTracers_diagnostic_fields_level4", 2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_ecosysTracers_diagnostic_fields_level5", 2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_use_DMSTracers", 2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_use_DMSTracers_surface_bulk_forcing", 2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_use_DMSTracers_surface_restoring", 2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_use_DMSTracers_interior_restoring", 2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_use_DMSTracers_exponential_decay", 2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_use_DMSTracers_idealAge_forcing", 2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_use_DMSTracers_ttd_forcing", 2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_use_DMSTracers_surface_value", 2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_use_DMSTracers_sea_ice_coupling", 2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_use_MacroMoleculesTracers", 2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_use_MacroMoleculesTracers_surface_bulk_forcing", 2,
                        "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_use_MacroMoleculesTracers_surface_restoring", 2,
                        "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_use_MacroMoleculesTracers_interior_restoring", 2,
                        "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_use_MacroMoleculesTracers_exponential_decay", 2,
                        "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_use_MacroMoleculesTracers_idealAge_forcing", 2,
                        "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_use_MacroMoleculesTracers_ttd_forcing", 2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_use_MacroMoleculesTracers_surface_value", 2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_use_MacroMoleculesTracers_sea_ice_coupling", 2,
                        "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_globalStats_enable", 3, "YES");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_globalStats_compute_interval", 15,
                        "output_interval");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_globalStats_compute_on_startup", 3, "YES");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_globalStats_write_on_startup", 2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_globalStats_text_file", 2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_globalStats_directory", 16, "analysis_members");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_globalStats_output_stream", 17,
                        "globalStatsOutput");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_surfaceAreaWeightedAverages_enable", 3, "YES");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_surfaceAreaWeightedAverages_compute_on_startup",
                        3, "YES");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_surfaceAreaWeightedAverages_write_on_startup",
                        2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_surfaceAreaWeightedAverages_compute_interval",
                        19, "0000-00-00_01:00:00");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_surfaceAreaWeightedAverages_output_stream", 33,
                        "surfaceAreaWeightedAveragesOutput");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_waterMassCensus_enable", 2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_waterMassCensus_compute_interval", 19,
                        "0000-00-00_01:00:00");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_waterMassCensus_output_stream", 21,
                        "waterMassCensusOutput");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_waterMassCensus_compute_on_startup", 3, "YES");
    CHECK_ERR
    ...
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_waterMassCensus_compute_predefined_regions", 3,
                        "YES");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_waterMassCensus_region_group", 0, "");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_layerVolumeWeightedAverage_enable", 3, "YES");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_layerVolumeWeightedAverage_compute_interval",
                        19, "0000-00-00_01:00:00");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_layerVolumeWeightedAverage_compute_on_startup",
                        3, "YES");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_layerVolumeWeightedAverage_write_on_startup", 2,
                        "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_layerVolumeWeightedAverage_output_stream", 32,
                        "layerVolumeWeightedAverageOutput");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_zonalMean_enable", 2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_zonalMean_compute_on_startup", 3, "YES");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_zonalMean_write_on_startup", 2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_zonalMean_compute_interval", 19,
                        "0000-00-00_01:00:00");
    CHECK_ERR
    err =
    ...
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_okuboWeiss_compute_on_startup", 3, "YES");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_okuboWeiss_write_on_startup", 2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_okuboWeiss_compute_interval", 19,
                        "0000-00-00_01:00:00");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_okuboWeiss_output_stream", 16,
                        "okuboWeissOutput");
    CHECK_ERR
    ...
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_okuboWeiss_compute_eddy_census", 3, "YES");
    CHECK_ERR
    iattr = 20;
    err =
    ...
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_meridionalHeatTransport_compute_interval", 19,
                        "0000-00-00_01:00:00");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_meridionalHeatTransport_compute_on_startup", 3,
                        "YES");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_meridionalHeatTransport_write_on_startup", 2,
                        "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_meridionalHeatTransport_output_stream", 29,
    ...
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_testComputeInterval_enable", 2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_testComputeInterval_compute_interval", 17,
                        "00-00-01_00:00:00");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_testComputeInterval_compute_on_startup", 3,
                        "YES");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_testComputeInterval_write_on_startup", 2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_testComputeInterval_output_stream", 25,
                        "testComputeIntervalOutput");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_highFrequencyOutput_enable", 3, "YES");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_highFrequencyOutput_compute_interval", 15,
                        "output_interval");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_highFrequencyOutput_output_stream", 19,
                        "highFrequencyOutput");
    CHECK_ERR
    err =
        PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_highFrequencyOutput_compute_on_startup", 2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_highFrequencyOutput_write_on_startup", 2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_timeFilters_enable", 2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_timeFilters_compute_interval", 2, "dt");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_timeFilters_output_stream", 17,
                        "timeFiltersOutput");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_timeFilters_restart_stream", 18,
                        "timeFiltersRestart");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_timeFilters_compute_on_startup", 3, "YES");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_timeFilters_write_on_startup", 2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_timeFilters_initialize_filters", 3, "YES");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_timeFilters_tau", 11, "90_00:00:00");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_timeFilters_compute_cell_centered_values", 3,
                        "YES");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_lagrPartTrack_enable", 2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_lagrPartTrack_compute_interval", 2, "dt");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_lagrPartTrack_compute_on_startup", 2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_lagrPartTrack_output_stream", 19,
                        "lagrPartTrackOutput");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_lagrPartTrack_restart_stream", 20,
                        "lagrPartTrackRestart");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_lagrPartTrack_input_stream", 18,
                        "lagrPartTrackInput");
    CHECK_ERR
    ...
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_lagrPartTrack_reset_global_timestamp", 13,
                        "0000_00:00:00");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_lagrPartTrack_region_stream", 20,
                        "lagrPartTrackRegions");
    CHECK_ERR
    err =
        PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_lagrPartTrack_reset_if_outside_region", 2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_lagrPartTrack_reset_if_inside_region", 2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_eliassenPalm_enable", 2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_eliassenPalm_compute_interval", 15,
                        "output_interval");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_eliassenPalm_output_stream", 18,
                        "eliassenPalmOutput");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_eliassenPalm_restart_stream", 19,
                        "eliassenPalmRestart");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_eliassenPalm_compute_on_startup", 3, "YES");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_eliassenPalm_write_on_startup", 2, "NO");
    CHECK_ERR
    ...
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_mixedLayerDepths_compute_interval", 19,
                        "0000-00-00_01:00:00");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_mixedLayerDepths_output_stream", 22,
                        "mixedLayerDepthsOutput");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_mixedLayerDepths_write_on_startup", 2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_mixedLayerDepths_compute_on_startup", 3, "YES");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_mixedLayerDepths_Tthreshold", 3, "YES");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_mixedLayerDepths_Dthreshold", 3, "YES");
    CHECK_ERR
    dattr = 0.2;
    ...
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_mixedLayerDepths_Dgradient", 2, "NO");
    CHECK_ERR
    dattr = 5.e-07;
    ...
    CHECK_ERR
    err =
        PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_regionalStatsDaily_compute_on_startup", 2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_regionalStatsDaily_write_on_startup", 2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_regionalStatsDaily_compute_interval", 15,
                        "output_interval");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_regionalStatsDaily_output_stream", 24,
                        "regionalStatsDailyOutput");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_regionalStatsDaily_restart_stream", 18,
                        "regionalMasksInput");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_regionalStatsDaily_input_stream", 18,
                        "regionalMasksInput");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_regionalStatsDaily_operation", 3, "avg");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_regionalStatsDaily_region_type", 4, "cell");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_regionalStatsDaily_region_group", 3, "all");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_regionalStatsDaily_1d_weighting_function", 3,
                        "mul");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_regionalStatsDaily_2d_weighting_function", 3,
                        "mul");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_regionalStatsDaily_1d_weighting_field", 8,
                        "areaCell");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_regionalStatsDaily_2d_weighting_field", 10,
                        "volumeCell");
    CHECK_ERR
    err =
        PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_regionalStatsDaily_vertical_mask", 8, "cellMask");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_regionalStatsDaily_vertical_dimension", 11,
                        "nVertLevels");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_regionalStatsWeekly_enable", 2, "NO");
    CHECK_ERR
    err =
        PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_regionalStatsWeekly_compute_on_startup", 2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_regionalStatsWeekly_write_on_startup", 2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_regionalStatsWeekly_compute_interval", 15,
                        "output_interval");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_regionalStatsWeekly_output_stream", 25,
                        "regionalStatsWeeklyOutput");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_regionalStatsWeekly_restart_stream", 18,
                        "regionalMasksInput");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_regionalStatsWeekly_input_stream", 18,
                        "regionalMasksInput");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_regionalStatsWeekly_operation", 3, "avg");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_regionalStatsWeekly_region_type", 4, "cell");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_regionalStatsWeekly_region_group", 3, "all");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_regionalStatsWeekly_1d_weighting_function", 3,
                        "mul");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_regionalStatsWeekly_2d_weighting_function", 3,
                        "mul");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_regionalStatsWeekly_1d_weighting_field", 8,
                        "areaCell");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_regionalStatsWeekly_2d_weighting_field", 10,
                        "volumeCell");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_regionalStatsWeekly_vertical_mask", 8,
                        "cellMask");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_regionalStatsWeekly_vertical_dimension", 11,
                        "nVertLevels");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_regionalStatsMonthly_enable", 2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_regionalStatsMonthly_compute_on_startup", 2,
                        "NO");
    CHECK_ERR
    err =
        PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_regionalStatsMonthly_write_on_startup", 2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_regionalStatsMonthly_compute_interval", 15,
                        "output_interval");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_regionalStatsMonthly_output_stream", 26,
                        "regionalStatsMonthlyOutput");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_regionalStatsMonthly_restart_stream", 18,
                        "regionalMasksInput");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_regionalStatsMonthly_input_stream", 18,
                        "regionalMasksInput");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_regionalStatsMonthly_operation", 3, "avg");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_regionalStatsMonthly_region_type", 4, "cell");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_regionalStatsMonthly_region_group", 3, "all");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_regionalStatsMonthly_1d_weighting_function", 3,
                        "mul");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_regionalStatsMonthly_2d_weighting_function", 3,
                        "mul");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_regionalStatsMonthly_1d_weighting_field", 8,
                        "areaCell");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_regionalStatsMonthly_2d_weighting_field", 10,
                        "volumeCell");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_regionalStatsMonthly_vertical_mask", 8,
                        "cellMask");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_regionalStatsMonthly_vertical_dimension", 11,
                        "nVertLevels");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_regionalStatsCustom_enable", 2, "NO");
    CHECK_ERR
    err =
        PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_regionalStatsCustom_compute_on_startup", 2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_regionalStatsCustom_write_on_startup", 2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_regionalStatsCustom_compute_interval", 15,
                        "output_interval");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_regionalStatsCustom_output_stream", 25,
                        "regionalStatsCustomOutput");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_regionalStatsCustom_restart_stream", 18,
                        "regionalMasksInput");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_regionalStatsCustom_input_stream", 18,
                        "regionalMasksInput");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_regionalStatsCustom_operation", 3, "avg");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_regionalStatsCustom_region_type", 4, "cell");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_regionalStatsCustom_region_group", 3, "all");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_regionalStatsCustom_1d_weighting_function", 3,
                        "mul");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_regionalStatsCustom_2d_weighting_function", 3,
                        "mul");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_regionalStatsCustom_1d_weighting_field", 8,
                        "areaCell");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_regionalStatsCustom_2d_weighting_field", 10,
                        "volumeCell");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_regionalStatsCustom_vertical_mask", 8,
                        "cellMask");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_regionalStatsCustom_vertical_dimension", 11,
                        "nVertLevels");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_timeSeriesStatsDaily_enable", 2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_timeSeriesStatsDaily_compute_on_startup", 2,
                        "NO");
    CHECK_ERR
    err =
        PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_timeSeriesStatsDaily_write_on_startup", 2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_timeSeriesStatsDaily_compute_interval", 17,
                        "00-00-00_01:00:00");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_timeSeriesStatsDaily_output_stream", 26,
                        "timeSeriesStatsDailyOutput");
    CHECK_ERR
    err =
        PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_timeSeriesStatsDaily_restart_stream", 4, "none");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_timeSeriesStatsDaily_operation", 3, "avg");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_timeSeriesStatsDaily_reference_times", 12,
                        "initial_time");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_timeSeriesStatsDaily_duration_intervals", 15,
                        "repeat_interval");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_timeSeriesStatsDaily_repeat_intervals", 14,
                        "reset_interval");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_timeSeriesStatsDaily_reset_intervals", 17,
                        "00-00-01_00:00:00");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_timeSeriesStatsDaily_backward_output_offset",
                        17, "00-00-01_00:00:00");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_timeSeriesStatsMonthly_enable", 3, "YES");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_timeSeriesStatsMonthly_compute_on_startup", 2,
                        "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_timeSeriesStatsMonthly_write_on_startup", 2,
                        "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_timeSeriesStatsMonthly_compute_interval", 17,
                        "00-00-00_01:00:00");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_timeSeriesStatsMonthly_output_stream", 28,
                        "timeSeriesStatsMonthlyOutput");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_timeSeriesStatsMonthly_restart_stream", 4,
                        "none");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_timeSeriesStatsMonthly_operation", 3, "avg");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_timeSeriesStatsMonthly_reference_times", 12,
                        "initial_time");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_timeSeriesStatsMonthly_duration_intervals", 15,
                        "repeat_interval");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_timeSeriesStatsMonthly_repeat_intervals", 14,
                        "reset_interval");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_timeSeriesStatsMonthly_reset_intervals", 17,
                        "00-01-00_00:00:00");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_timeSeriesStatsMonthly_backward_output_offset",
                        17, "00-01-00_00:00:00");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_timeSeriesStatsClimatology_enable", 2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_timeSeriesStatsClimatology_compute_on_startup",
                        2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_timeSeriesStatsClimatology_write_on_startup", 2,
                        "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_timeSeriesStatsClimatology_compute_interval",
                        17, "00-00-00_01:00:00");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_timeSeriesStatsClimatology_output_stream", 32,
                        "timeSeriesStatsClimatologyOutput");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_timeSeriesStatsClimatology_restart_stream", 33,
                        "timeSeriesStatsClimatologyRestart");
    CHECK_ERR
    err =
        PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_timeSeriesStatsClimatology_operation", 3, "avg");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_timeSeriesStatsClimatology_reference_times", 71,
                        "00-03-01_00:00:00;00-06-01_00:00:00;00-09-01_00:00:00;00-12-01_00:00:00");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_timeSeriesStatsClimatology_duration_intervals",
                        71,
                        "00-03-00_00:00:00;00-03-00_00:00:00;00-03-00_00:00:00;00-03-00_00:00:00");
    CHECK_ERR
    err =
        PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_timeSeriesStatsClimatology_repeat_intervals", 71,
    ...
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL,
                        ...
                        "00-03-00_00:00:00");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_timeSeriesStatsCustom_enable", 2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_timeSeriesStatsCustom_compute_on_startup", 2,
                        "NO");
    CHECK_ERR
    err =
        PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_timeSeriesStatsCustom_write_on_startup", 2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_timeSeriesStatsCustom_compute_interval", 17,
                        "00-00-00_01:00:00");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_timeSeriesStatsCustom_output_stream", 27,
                        "timeSeriesStatsCustomOutput");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_timeSeriesStatsCustom_restart_stream", 28,
                        "timeSeriesStatsCustomRestart");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_timeSeriesStatsCustom_operation", 3, "avg");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_timeSeriesStatsCustom_reference_times", 12,
                        "initial_time");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_timeSeriesStatsCustom_duration_intervals", 15,
                        "repeat_interval");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_timeSeriesStatsCustom_repeat_intervals", 14,
                        "reset_interval");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_timeSeriesStatsCustom_reset_intervals", 17,
                        "00-00-07_00:00:00");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_timeSeriesStatsCustom_backward_output_offset",
                        17, "00-00-01_00:00:00");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_pointwiseStats_enable", 2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_pointwiseStats_compute_interval", 15,
                        "output_interval");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_pointwiseStats_output_stream", 20,
                        "pointwiseStatsOutput");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_pointwiseStats_compute_on_startup", 3, "YES");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_pointwiseStats_write_on_startup", 2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_debugDiagnostics_enable", 2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_debugDiagnostics_compute_interval", 2, "dt");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_debugDiagnostics_output_stream", 22,
                        "debugDiagnosticsOutput");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_debugDiagnostics_compute_on_startup", 3, "YES");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_debugDiagnostics_write_on_startup", 2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_debugDiagnostics_check_state", 3, "YES");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_rpnCalculator_enable", 2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_rpnCalculator_compute_on_startup", 3, "YES");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_rpnCalculator_write_on_startup", 2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_rpnCalculator_compute_interval", 19,
                        "0010-00-00_00:00:00");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_rpnCalculator_output_stream", 4, "none");
    CHECK_ERR
    err =
        PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_rpnCalculator_variable_a", 14, "layerThickness");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_rpnCalculator_variable_b", 8, "areaCell");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_rpnCalculator_variable_c", 4, "none");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_rpnCalculator_variable_d", 4, "none");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_rpnCalculator_variable_e", 4, "none");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_rpnCalculator_variable_f", 4, "none");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_rpnCalculator_variable_g", 4, "none");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_rpnCalculator_variable_h", 4, "none");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_rpnCalculator_expression_1", 5, "a b *");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_rpnCalculator_expression_2", 4, "none");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_rpnCalculator_expression_3", 4, "none");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_rpnCalculator_expression_4", 4, "none");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_rpnCalculator_output_name_1", 10, "volumeCell");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_rpnCalculator_output_name_2", 4, "none");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_rpnCalculator_output_name_3", 4, "none");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_rpnCalculator_output_name_4", 4, "none");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_transectTransport_enable", 2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_transectTransport_compute_interval", 15,
                        "output_interval");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_transectTransport_output_stream", 23,
                        "transectTransportOutput");
    CHECK_ERR
    err =
        PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_transectTransport_compute_on_startup", 3, "YES");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_transectTransport_write_on_startup", 2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_transectTransport_transect_group", 3, "all");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_eddyProductVariables_enable", 3, "YES");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_eddyProductVariables_compute_interval", 19,
                        "0000-00-00_01:00:00");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_eddyProductVariables_output_stream", 26,
                        "eddyProductVariablesOutput");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_eddyProductVariables_compute_on_startup", 3,
                        "YES");
    CHECK_ERR
    err =
        PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_eddyProductVariables_write_on_startup", 2, "NO");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_mocStreamfunction_enable", 3, "YES");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_mocStreamfunction_compute_interval", 19,
                        "0000-00-00_01:00:00");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_mocStreamfunction_output_stream", 23,
                        "mocStreamfunctionOutput");
    CHECK_ERR
    err =
        PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_mocStreamfunction_compute_on_startup", 3, "YES");
    CHECK_ERR
    ...
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_mocStreamfunction_vertical_velocity_value", 15,
                        "vertVelocityTop");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_mocStreamfunction_normal_velocity_value", 14,
                        "normalVelocity");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_mocStreamfunction_region_group", 3, "all");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "config_AM_mocStreamfunction_transect_group", 3, "all");
    CHECK_ERR
    err = PUT_ATT_TEXT (ncid, NC_GLOBAL, "file_id", 10, "3q7jdjett8");
    CHECK_ERR
